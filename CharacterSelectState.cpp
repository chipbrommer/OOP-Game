...
void CharacterSelectState::Init()
{
    ...
    //Start game text that overlays the blank button.
    {
        ...
        startGame.setColor(sf::Color::Color(128,128,128,255));
    ...
    //Name for Andrea Llama that is under the lama.
    {
        ...
        andrea.setColor(sf::Color::White);
...
void CharacterSelectState::HandleInput()
{
    ...
    while (this->_data->window.pollEvent(event))
    {
        ...
        {
            startGame.setColor(sf::Color::Magenta);
            spriteClicked = true;
            spriteNumber = 5;
        }
        ...
        {
            startGame.setColor(sf::Color::Cyan);
            spriteClicked = true;
            spriteNumber = 6;
        }
        ...
        if(spriteClicked == true)
        {
            ...
            {
                //this->_data->machine.AddState(StateRef(new RunGame(_data)), true);
                //GameRunState::SetGameSprite(spriteNumber);
