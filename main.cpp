...
int main()
{
    ...
    if ( !menuBackground.loadFromFile("../Resources/Images/VolcanoBG.png") )
    {
    ...
    if (!gameFontBold.loadFromFile("../Resources/Font/WalkwayBold.ttf))
    {
        std::cout << "Error: Can't load bold font file." << std::endl;
    }
    
    sf::Font gameFont;
    if (!gameFont.loadFromFile(""../Resources/Font/Walkway.ttf"))
    {
